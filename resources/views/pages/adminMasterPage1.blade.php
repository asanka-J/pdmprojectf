...
<head>
    ...
    <script   src="{{ url('https://code.jquery.com/jquery-2.2.2.min.js') }}"   integrity="sha256-36cp2Co+/62rEAAYHLmRCPIych47CvdM+uTBJwSzWjI="   crossorigin="anonymous"></script>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li>  <a href="#">   <i class="fa fa-envelope"></i> <span>Add a New Submission</span></a></li>
                <li>  <a href="/profile">   <i class="fa fa-envelope"></i> <span>My Profile</span></a></li>
